...
To delete post/comment from favorites you should do:

  @user.unfavorite @post

To check that post/comment enters in favorites you should do:

  @user.favorite? @post

To return favorite line, consisting of favorited posts and comments, you should do:
...
To delete post/comment from reblogs you should do:

  @user.unreblog @post

To check that post/comment enters in reblogs you should do:
...
To get comment line you should do:
...
To unfollow user you should do:

  @user.unfollow @another_user

To check that user is follower of another user you should do:

  @user.follow? @another_user

To get followers ids for user and ids of users, which he follow, you should do:
